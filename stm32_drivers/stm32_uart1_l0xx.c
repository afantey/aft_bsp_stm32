...
static int32_t stm32_uart1_open(sdk_uart_t *uart, int32_t baudrate, int32_t data_bit, char parity, int32_t stop_bit)
{
...
static int32_t stm32_uart1_close(sdk_uart_t *uart)
{
...
static int32_t stm32_uart1_putc(sdk_uart_t *uart, int32_t ch)
{
...
static int32_t stm32_uart1_getc(sdk_uart_t *uart)
{
    int ch = -1;
...
static int32_t stm32_uart1_control(sdk_uart_t *uart, int32_t cmd, void *args)
{
    switch (cmd)
    {
    ...
    case SDK_CONTROL_UART_INT_IDLE_ENABLE:
        ...
        while (0 == LL_USART_IsActiveFlag_IDLE(USART1))
        {
        }
...
sdk_uart_t uart1 = 
{
    .ops.open = stm32_uart1_open,
    .ops.close = stm32_uart1_close,
    .ops.putc = stm32_uart1_putc,
    .ops.getc = stm32_uart1_getc,
    .ops.control = stm32_uart1_control,
    .rx_callback = NULL,
